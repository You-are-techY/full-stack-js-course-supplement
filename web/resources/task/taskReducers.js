...
function task(state = {
   ...
   *
   * For example, when fetching a nested list of tasks by type and color you
   * would write something like:
   * let list = taskStore.util.getList('type', 'apparel', 'color', 'black')
   */
  , util: {
    getKeyArrayFromList: () => {
      return null
  ...
  switch(action.type) {
    ...
    case Actions.REQUEST_TASK_SCHEMA: {
      nextState = {
        ...state
        , defaultItem: {
          ...state.defaultItem
    ...
    case Actions.RECEIVE_TASK_SCHEMA: {
      if(action.success) {
        nextState = {
          ...state
          , defaultItem: {
