...
export function fetchSingleTaskById(id) {
  return dispatch => {
    dispatch(requestSingleTask(id))
    return apiUtils.callAPI(`/api/tasks/${id}`)
...
export const REQUEST_TASK_SCHEMA = "REQUEST_TASK_SCHEMA";
function requestTaskSchema(id) {
  return {
    type: REQUEST_TASK_SCHEMA
  }
}
 export const RECEIVE_TASK_SCHEMA = "RECEIVE_TASK_SCHEMA";
